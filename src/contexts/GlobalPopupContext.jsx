...
export function GlobalPopupProvider({ children }) {
  ...
  return (
    <GlobalPopupContext.Provider value={{ openPopup, closePopup }}>
      ...
      {PopupComponent && (
        <Fragment>
        <div onClick={closePopup} className="animate-fade animate-duration-100 fixed top-0 left-0 w-full h-full bg-black/50 flex flex-col items-center justify-center z-1 text-[#cdd6f4]">
            ...
            <div onClick={(e) => e.stopPropagation()} className="animate-open bg-white/20 dark:bg-[#1e1e2e] dark:ring-1 dark:ring-[#45475a] backdrop-blur-2xl p-2 rounded-xl z-2">
